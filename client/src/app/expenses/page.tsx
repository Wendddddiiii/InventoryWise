...
const Expenses = () => {
  ...
  // useMemo: memorize the result of the function
  // so it only recalculates when dependencies change
  const aggregatedData: AggregatedDataItem[] = useMemo(() => {
    type Category = 'Office' | 'Salaries' | 'Professional';
    ...
    const filtered: AggregatedData = expenses
      ...
      .reduce((acc: AggregatedData, data: ExpenseByCategorySummary) => {
        ...
        if (!acc[data.category]) {
            ...
            name: data.category, 
            amount: 0, 
            color: categoryColors[data.category as Category]
            };
        }
